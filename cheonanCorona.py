...
# 중간 저장하기
Cheonan_map.save(r'C:\Users\LJM\Documents\GitHub\coronaNum\Cheonan.html')
...
folium.Marker(loc_1, popup='1불당대동다숲 아파트', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
folium.Marker(loc_2, popup='2두정동 세광2차 아파트', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
folium.Marker(loc_3, popup='3불당지웰더샵 아파트', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
folium.Marker(loc_4, popup='4불당아이파크 아파트', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
folium.Marker(loc_5, popup='5불당동일하이빌 아파트', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
folium.Marker(loc_6, popup='6불당동 린스트라우스2차 아파트', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
folium.Marker(loc_7, popup='7불당아이파크 아파트', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
folium.Marker(loc_8, popup='8불당호반3차 아파트', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
folium.Marker(loc_9, popup='9쌍용동 용암마을 아파트', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
folium.Marker(loc_10, popup='10두정동 푸르지오 4차 아파트', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
folium.Marker(loc_11, popup='11북면 단독주택', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
folium.Marker(loc_14, popup='14두정동 푸르지오 4차 아파트', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
folium.Marker(loc_15, popup='15신부동', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
folium.Marker(loc_16, popup='16불당지웰푸르지오 아파트', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
folium.Marker(loc_17, popup='17e편한세상 두정2차 아파트', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
folium.Marker(loc_20, popup='20쌍용마을 뜨란채 아파트', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
folium.Marker(loc_21, popup='21천안영성 펜타폴리스', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
folium.Marker(loc_23, popup='23백석동 주공그린빌11단지3차 아파트', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
folium.Marker(loc_25, popup='25불당동 린스트라우스2차 아파트', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
folium.Marker(loc_26, popup='26불당지웰시티푸르지오 2단지', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
...
#28번째 확진자
home_28 = '용곡동 현대아이파크'
tmp = gmaps.geocode('용곡동 현대아이파크', language='ko')
tmp_loc=tmp[0].get('geometry').get('location')
loc_28=[tmp_loc['lat'], tmp_loc['lng']]

if home_28 in homes :
    loc_28=[tmp_loc['lat']+0.0005, tmp_loc['lng']+0.0005]
else :
    homes.append(home_28)

folium.Marker(loc_28, popup='28용곡동 현대아이파크', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
#folium.CircleMarker(loc_28, radius=25, fill=True, popup='천안시 28번', color='red', fill_color='orange').add_to(Cheonan_map)



#29번째 확진자
home_29 = '봉명동 일양빌라'
tmp = gmaps.geocode('충청남도 천안시 동남구 양지4길 51', language='ko')
tmp_loc=tmp[0].get('geometry').get('location')
loc_29=[tmp_loc['lat'], tmp_loc['lng']]

if home_29 in homes :
    loc_29=[tmp_loc['lat']+0.0005, tmp_loc['lng']+0.0005]
else :
    homes.append(home_29)

folium.Marker(loc_29, popup='29봉명동 일양빌라', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
#folium.CircleMarker(loc_29, radius=25, fill=True, popup='천안시 29번', color='red', fill_color='orange').add_to(Cheonan_map)



#31번째 확진자
home_31 = '백석동'
tmp = gmaps.geocode('천안시 백석동', language='ko')
tmp_loc=tmp[0].get('geometry').get('location')
loc_31=[tmp_loc['lat'], tmp_loc['lng']]

if home_31 in homes :
    loc_31=[tmp_loc['lat']+0.0005, tmp_loc['lng']+0.0005]
else :
    homes.append(home_31)

folium.Marker(loc_31, popup='31백석동 일반상가', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
#folium.CircleMarker(loc_31, radius=25, fill=True, popup='천안시 31번', color='red', fill_color='orange').add_to(Cheonan_map)
...
folium.Marker(loc_33, popup='33성정동 상아빌라', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
#folium.CircleMarker(loc_33, radius=25, fill=True, popup='천안시 33번', color='red', fill_color='orange').add_to(Cheonan_map)



#56번째 확진자
home_56 = '성정동 주공5단지 아파트'
tmp = gmaps.geocode('충청남도 천안시 서북구 성정1동 717', language='ko')
tmp_loc=tmp[0].get('geometry').get('location')
loc_56=[tmp_loc['lat'], tmp_loc['lng']]

if home_56 in homes :
    loc_56=[tmp_loc['lat']+0.0005, tmp_loc['lng']+0.0005]
else :
    homes.append(home_56)

folium.Marker(loc_56, popup='56성정동 주공5단지 아파트', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
#folium.CircleMarker(loc_56, radius=25, fill=True, popup='천안시 56번', color='red', fill_color='orange').add_to(Cheonan_map)



#58번째 확진자
home_58 = '쌍용동 파크밸리 동일하이빌 아파트'
tmp = gmaps.geocode('쌍용동 파크밸리 동일하이빌 아파트', language='ko')
tmp_loc=tmp[0].get('geometry').get('location')
loc_58=[tmp_loc['lat'], tmp_loc['lng']]

if home_58 in homes :
    loc_58=[tmp_loc['lat']+0.0005, tmp_loc['lng']+0.0005]
else :
    homes.append(home_58)

folium.Marker(loc_58, popup='58쌍용동 파크밸리 동일하이빌 아파트', icon=folium.Icon(color='red', icon='star')).add_to(marker_cluster)
#folium.CircleMarker(loc_58, radius=25, fill=True, popup='천안시 58번', color='red', fill_color='orange').add_to(Cheonan_map)
